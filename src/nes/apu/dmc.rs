...
impl Dmc {
    pub fn new(region: Region) -> Self {
        ...
        Self {
            ...
            loop_flag: false,
            period,
            // 8-cycle reset (now that `cpu::reset` matches Mesen2's
            // power-up loop length) ticks DMC eight times before the
            // first ROM instruction, same as Mesen. No initial-timer
            // skew is needed here.
            timer: period,
