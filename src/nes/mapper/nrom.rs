...
impl Mapper for Nrom {
    ...
    fn save_state_capture(&self) -> Option<crate::save_state::MapperState> {
        use crate::save_state::mapper::{MirroringSnap, NromSnap};
        Some(crate::save_state::MapperState::Nrom(NromSnap {
    ...
    fn save_state_apply(
        ...
        let crate::save_state::MapperState::Nrom(snap) = state else {
