...
impl Mapper for Mmc2 {
    ...
    fn save_state_capture(&self) -> Option<crate::save_state::MapperState> {
        use crate::save_state::mapper::{MirroringSnap, Mmc2Snap};
        Some(crate::save_state::MapperState::Mmc2(Mmc2Snap {
    ...
    fn save_state_apply(
        ...
        let crate::save_state::MapperState::Mmc2(snap) = state else {
