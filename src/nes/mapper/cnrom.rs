...
impl Mapper for Cnrom {
    ...
    fn save_state_capture(&self) -> Option<crate::save_state::MapperState> {
        use crate::save_state::mapper::{CnromSnap, MirroringSnap};
        Some(crate::save_state::MapperState::Cnrom(CnromSnap {
    ...
    fn save_state_apply(
        ...
        let crate::save_state::MapperState::Cnrom(snap) = state else {
