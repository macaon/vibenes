...
pub fn build(cart: Cartridge) -> Result<Box<dyn Mapper>> {
    match cart.mapper_id {
        ...
        77 => Ok(Box::new(irem_lrog017::IremLrog017::new(cart))),
        ...
        101 => Ok(Box::new(jaleco_jf10::JalecoJf10::new(cart))),
        ...
        157 => Ok(Box::new(bandai_datach::BandaiDatach::new(cart))),
